import { CachedQuestion } from '@/lib/community';

/**
 * Mock community chat data
 * Used as fallback when Firestore is empty or unavailable
 */
export const mockCommunityChats: CachedQuestion[] = [
  {
    id: "mock1",
    userId: "mock_user_1",
  ...
  },
  {
    ...
    cropTag: "Tomato",
    cropEmoji: "🍅",
    questionText: "Tomato mandi price dropped today. Should I store harvest?",
  ...
  },
  {
    ...
    lastReplyAt: new Date(Date.now() - 7 * 60 * 60 * 1000), // 7 hours ago
  },
  {
    id: "mock7",
    userId: "mock_user_7",
  ...
  },
  {
    ...
    lastReplyAt: new Date(Date.now() - 18 * 60 * 60 * 1000), // 18 hours ago
  },
  {
    id: "mock9",
    userId: "mock_user_9",
    ...
    lastReplyAt: new Date(Date.now() - 20 * 60 * 60 * 1000), // 20 hours ago
  },
  {
    id: "mock10",
    userId: "mock_user_10",
  ...
  },
  {
    ...
    lastReplyAt: new Date(Date.now() - 30 * 60 * 60 * 1000), // 30 hours ago
  },
  {
    id: "mock12",
    userId: "mock_user_12",
    ...
    cropTag: "Groundnut",
    cropEmoji: "🥜",
    questionText: "Best fungicide for groundnut leaf spot disease?",
    description: "Dark brown spots with yellow margins on groundnut leaves. Tried copper fungicide but not much improvement. Should I switch to Mancozeb? What's your recommendation?",
    upvotes: 7,
    upvotedBy: [],
    repliesCount: 4,
    createdAt: new Date(Date.now() - 60 * 60 * 60 * 1000), // 2.5 days ago
    lastReplyAt: new Date(Date.now() - 36 * 60 * 60 * 1000), // 36 hours ago
  },
];
